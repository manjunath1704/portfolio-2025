    ...
    return (
        ...
        <section className="py-20">
            <div className="md:flex md:justify-between md:items-center border-b-2 border-neutral-30 pb-8 mb-8 md:pb-12 md:mb-12">
                ...
                <Link className='text-sm md:text-lg text-neutral-100 flex items-center hover:text-neutral-40' href="/work"><span className='me-3'>View All Works</span> <ArrowRight className='text-3xl'/></Link>
            </div>
